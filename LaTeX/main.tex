	...
	\begin{subfigure}[t]{0.45\textwidth}
		...
		\begin{tikzpicture}[scale=0.8, every node/.style={transform shape}]
			...
			\draw[<->, thick] (5,5) -- (5,7.2)
				node[midway,fill=white,text=black,xshift=-0.2cm]
				{\scriptsize $\dfrac{e^2}{C_{\Sigma}} + \Delta_{N+1}$};
			\draw[<->, thick] (6.4,1) -- (6.4,2.5)
				node[midway,fill=black!40!white,text=black,xshift=+0.3cm]
	...
	\begin{subfigure}[t]{0.45\textwidth}
		...
		\begin{tikzpicture}[scale=0.8, every node/.style={transform shape}]
			...
			\draw[<->, thick] (6.4,1.8) -- (6.4,2.5)
				node[midway,fill=black!40!white,text=black,xshift=+0.92cm]
				{\scriptsize $U_{N}(V_G)$};
...
The diamond-shaped structure shown in Figure \ref{fig:diamond_regions} have been shown in differential conductance measurements like the one shown in Figure \ref{fig:Figure_8_Reimann}. A 3D version of this kind of experiment -- that clarifies the ideas a little bit -- is shown in Figure \ref{fig:diff_conductance_3D}.
...
\begin{figure}[H]
	...
	\input{figures/diff_conductance_3D.pdf_tex}
...
%%\bibitem[Autors]{short name}
%%  Surname1, Name1. and Surname2, Name2.
%%  (Year, Month).
%%  Title.
%%  \emph{Journal, Volume}(Issue),
%%  {Pages}.
%%  \texttt{DOI name},
%%  \texttt{\url{URL}}
%
...
%  
%\bibitem[Reimann, et al.]{reimann}
%  Reimann, Stephanie M. and Manninen, Matti
%  (2002, Nov).
%  Electronic structure of quantum dots.
%  \emph{Rev. Mod. Phys., 74}(4),
%  {1283--1342}.
%  \texttt{10.1103/RevModPhys.74.1283},
%  \texttt{\url{http://link.aps.org/doi/10.1103/RevModPhys.74.1283}}
